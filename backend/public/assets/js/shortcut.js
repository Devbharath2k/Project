...
var htmlCode = `
    ...
    <div
        ...
        <div class="vh-40">
            ...
            <a href="placement.html " class="popup text-decoration-none">
                <span>P</span>
                <span>a</span>
                <span>y</span>
                <span> </span>
        ...
        <div class="modal-dialog modal-dialog-centered p-5">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 linear-gradient-text text-center" id="exampleModalLabel" >Contact Form</h1>
                ...
                <div class="modal-body p-3">
                    <form id="contactForm">
                        ...
                        <div class="form-floating">             
                            <input type="number" class="form-control" id="phone" placeholder="Enter your phone number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" required>                               
                            <label for="phone">Phone Number <span class="text"> *</span></label> 
                        </div>
                        <div class="form-floating">                                
                            <textarea class="form-control" id="message" rows="3"
                                placeholder="Enter your message" style="height: 80px"></textarea>
                                <label for="message">Message <span>(Optional)</span></label>
                        </div>
                        <div id="output" class="text-center"></div>
                      <div class="text-center"> <button type="submit" class="btn btn-primary btn-block">Submit</button></div> 
                    </form> 
