    document.addEventListener("DOMContentLoaded", function () {
        ...
        const additionalContent = [
            ...
            <div class="box rounded-5 ">
                ...
                <div class="box-content">                           
                   <h2 class="text-decoration-none text-dark mt-3 ms-2 blog-category">not itCareer</h2>                   
                </div>
            </div>
            </a>
        ...
        <div class="col-md-4 pb-5" data-aos="fade-right" data-aos-duration="900">
            ...
            <div class="box rounded-5 ">
                <img src="./assets/img/Blog/blogimg.jpg">
                <div class="box-content">                           
                   <h2 class="text-decoration-none text-dark mt-3 ms-2 blog-category">not searching</h2>                   
                </div>
            </div>
            </a>
        ...
        <div class="col-md-4 pb-5" data-aos="fade-right" data-aos-duration="900">
            ...
            <div class="box rounded-5 ">
                <img src="./assets/img/Blog/blogimg.jpg">
                <div class="box-content">                           
                   <h2 class="text-decoration-none text-dark mt-3 ms-2 blog-category">not job race</h2>                   
                </div>
            </div>
            </a>
        ...
        <div class="col-md-4 pb-5" data-aos="fade-right" data-aos-duration="900">
            ...
            <div class="box rounded-5 ">
                <img src="./assets/img/Blog/blogimg.jpg">
                <div class="box-content">                           
                   <h2 class="text-decoration-none text-dark mt-3 ms-2 blog-category">not clearGoal</h2>                   
                </div>
            </div>
            </a>
        ...
        <div class="col-md-4 pb-5" data-aos="fade-right" data-aos-duration="900">
            ...
            <div class="box rounded-5 ">
                <img src="./assets/img/Blog/blogimg.jpg">
                <div class="box-content">                           
                   <h2 class="text-decoration-none text-dark mt-3 ms-2 blog-category">not it job</h2>                   
                </div>
            </div>
            </a>
        ...
        <div class="box rounded-5 ">
            <img src="./assets/img/Blog/blogimg.jpg">
            <div class="box-content">                           
               <h2 class="text-decoration-none text-dark mt-3 ms-2 blog-category"> not completeGiude</h2>                   
            </div>
        </div>
        </a>
    ...
    <div class="col-md-4 pb-5" data-aos="fade-right" data-aos-duration="900">
        ...
        <div class="box rounded-5 ">
            <img src="./assets/img/Blog/blogimg.jpg">
            <div class="box-content">                           
               <h2 class="text-decoration-none text-dark mt-3 ms-2 blog-category"> not dynamic duo</h2>                   
            </div>
        </div>
        </a>
    ...
    <div class="col-md-4 pb-5" data-aos="fade-right" data-aos-duration="900">
        ...
        <div class="box rounded-5 ">
            <img src="./assets/img/Blog/blogimg.jpg">
            <div class="box-content">                           
               <h2 class="text-decoration-none text-dark mt-3 ms-2 blog-category"> not mastering_technical</h2>                   
            </div>
        </div>
        </a>
